        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="{{route('dashboard')}}">
                ...
                <!-- Logo text --><span>
                    ...
                    <!-- Light Logo text -->
                         {{-- <img src="{{asset('/')}}back-end/assets/images/logo-light-text.png" class="light-logo" alt="homepage" /></span> </a> --}}
        </div>
        <!-- ============================================================== -->
        <!-- End Logo -->
        <!-- ============================================================== -->
        <div class="navbar-collapse">
            ...
            <ul class="navbar-nav my-lg-0">
                ...
                <li class="nav-item dropdown u-pro">
                    <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{asset('/')}}back-end/assets/images/users/1.jpg" alt="user" class=""> <span class="hidden-md-down">Mahedy <i class=""></i></span> </a>
